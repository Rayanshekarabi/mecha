...
class User(models.Model):
    ...
    # wallet = models.OneToOneField(to='Wallet', on_delete=models.CASCADE, default=None)

    # has a oneToOne rel with profile collections
    # profile = models.OneToOneField(to='Profile', on_delete=models.CASCADE, default=None)
